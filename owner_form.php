...
<body>
        ...
        <div class="container">
            <div class="row site-hero-inner justify-content-center align-items-center">
                <div class="col-md-10 text-center" data-aos="fade">
                    <h1 class="heading mb-3">Owner Section</h1>
    ...
    <section class="section contact-section" id="next">
      ...
      <h1 class="text-center">Room details</h1>
        <div class="row">
          <div class="col-md-7" data-aos="fade-up" data-aos-delay="100" style="margin-left:16vw">
            <!--FORM-->
            <form action="room.php" method="post" class="bg-white p-md-5 p-4 mb-5 border">
              <div class="row">
                <div class="col-md-6 form-group">
                  <label class="text-black font-weight-bold" for="name">Owner name</label>
                  <input type="text" id="name" name="name" class="form-control " required>
                </div>
                <div class="col-md-6 form-group">
                  <label class="text-black font-weight-bold" for="phone">Owner Phone</label>
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  <label class="text-black font-weight-bold" for="location">Location</label>
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  <label class="text-black font-weight-bold" for="pin">Pin code</label>
                  <input type="text" id="pin" name="pin" class="form-control "required>
                </div>
              </div>  
              <div class="row">
                <div class="col-md-12 form-group">
                  <label class="text-black font-weight-bold" for="type">Room Type</label>
                  <input type="text" id="type" name="type" class="form-control "required>
                </div>
              </div> 
              <div class="row mb-4">
                <div class="col-md-12 form-group">
                  <label class="text-black font-weight-bold" for="info">Room Information</label>
                  <textarea name="info" id="info" class="form-control " cols="30" rows="4"required></textarea>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12 form-group">
                  <label class="text-black font-weight-bold" for="price">Price /Month</label>
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="submit" value="Add room" class="btn btn-primary text-white py-3 px-5 mt-2 font-weight-bold">
                </div>
              </div>
            </form>
          </div>
