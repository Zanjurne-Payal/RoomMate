        ...
        <div class="row">
          <div class="col-md-7" data-aos="fade-up" data-aos-delay="100">
            ...
            if(!$login){
              ...
              <strong>Error!</strong> Please Enter Valid ussername or password
            ...
            <form action="login.php" method="post" class="bg-white p-md-5 p-4 mb-5 border">
              <div class="row">
                <div class="col-md-12 form-group">
                  ...
                  <input type="text" id="name" name="name1" class="form-control "required>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  ...
                  <input type="password" id="password" name="pass1" class="form-control "required>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12 form-group">
          ...
          <div class="col-md-5" data-aos="fade-up" data-aos-delay="200">
            <div class="row">
              <div class="col-md-10 ml-auto contact-info">
                ...
                <p><span class="d-block">Are you a new usser ? then register first<a href="registration.php"> REGISTER HERE</a></span></p>
              </div>
            </div>
          </div>
        </div>
