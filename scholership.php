...
<html>
  ...
  <body>
                ...
                <div class="container">
                  <div class="row full-height align-items-center">
                    ...
                    <ul class="list-unstyled menu">
                        ...
                        <li class="active"><a href="scholership.php">Scholership</a></li>
      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade">
            <h1 class="heading mb-3">Scholership</h1>
    ...
    <section class="section blog-post-entry bg-light" id="next">
      ...
      <div class="row">
       <?php
          $sql = "SELECT * FROM `scholership`";
          $result = mysqli_query($con, $sql);
          while($row=mysqli_fetch_array($result)){
            $time = $row["time"];
            $title= $row["s_title"];
            $info = $row["s_disc"];
            echo "<div class='col-lg-4 col-md-6 col-sm-6 col-12 post mb-5' data-aos='fade-up' data-aos-delay='200'>
            <div class='media media-custom d-block mb-4 h-100'>
              ...
              <div class='media-body'>
                ...
                <h2 class='mt-0 mb-3'><a href='#'>".$title."</a></h2>
                <p>".$info."</p>
              </div>
            </div>
          </div> ";
